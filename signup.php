...
$message .= "http://www.namansharma.host20.uk/NotesOnline/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'naman.sharma_cs20@gla.ac.in')){
