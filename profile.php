              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li><a href="#"> 
                      <?php
                                if(empty($picture)){
                                    echo "<div class='image_preview'  data-target='#updatepicture' data-toggle='modal'><img class='preview' src='profileImage/empty1.png' /></div>";
                                }else{
...
<!--Container-->
        ...
        <div class="modal" id="updatepicture" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <?php
                                if(empty($picture)){
                                    echo "<div class='image_preview text-center'><img class='preview2' src='profileImage/empty1.png' alt='Profile Image'/></div>";
                                }else{
                                    echo "<div class='image_preview text-center'><img class='preview2' src='$picture' alt='Profile Image'/></div>";
                                }
                              ?>
              <div class="modal-body">
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>namansharma.host20.uk &copy; 2021-<?php $today = date("Y"); echo $today?>.</p>
          </div>
      </div>
