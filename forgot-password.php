...
$message .= "http://namansharma.host20.uk/NotesOnline/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'naman.sharma_cs20@gla.ac.in')){
