...
$message .= "http://www.namansharma.host20.uk/NotesOnline/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'naman.sharma_cs20@gla.ac.in')){
